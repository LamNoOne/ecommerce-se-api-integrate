...
const Technical = (products) => {
    const productDetail = {
        ...
        frontCameraResolution: [
            ...
            products?.frontCameraResolution,
        ],
        rearCameraResolution: [
            "Rear camera resolution",
            products?.rearCameraResolution,
        ],
    ...
    return (
        <div className="technicalInfo flex flex-col overflow-hidden">
            <h2 className="text-base font-medium text-[#4a4a4a] mb-3">
                Specifications
            </h2>
            <ul className=" [&>*:nth-child(odd)]:bg-[#f2f2f2] border rounded-xl overflow-hidden">
                {Object.entries(productDetail).map(([key, [name, value]]) => (
                    <li
                        ...
                        <div className="text-sm text-[#4a4a4a] min-w-[150px]">
                            {value}
                        </div>
                    </li>
                ))}
